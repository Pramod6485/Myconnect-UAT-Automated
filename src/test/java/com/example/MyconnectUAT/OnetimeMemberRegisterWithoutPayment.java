...
public class OnetimeMemberRegisterWithoutPayment {
  ...
  public void testRegisterOnOneTimeMemberWithoutPaymentTestCase() throws Exception {
    ...
    driver.findElement(By.id("email")).sendKeys("pramod.oneTimee@yopmail.com");
    Thread.sleep(1200);
    ...
    System.out.println("One Time Membership Charge Setting Learners has been successfully Registered Without Payment");
    driver.close();
